                        ...
                        <div class="ref-checkout" style="display: flex;">
                            <div class="ref-checkout-content">
                                <form class="ref-details" style="display: block;">
                                    ...
                                    </label><label class="ref-phone-input"><span>Phone</span><input id="ref-field-phone" class="ref-form-control" type="tel" name="phone" value pattern="[0-9\+\- ]{5,30}" placeholder="{{ Auth::user()->no_telp }}" required data-state-src="phone" />
                                        <div class="ref-validation-error"></div>
                                            ...
                                            <fieldset class="ref-tab-content">
                                                ...
                                                <div class="ref-shipping-address-holder">
                                                    <div class="ref-address-widget"><label><span>Name</span><input class="ref-form-control ref-field-details-name" type="text" value name="shipping-name" data-state-src="shipping-name" disabled placeholder="{{ Auth::user()->name }}" required minlength="5" />
                                                            ...
                                                            <div class="ref-validation-error"></div>
                                                        </label><label><span>City</span><input class="ref-form-control ref-field-details-city" type="text" value name="shipping-city" data-state-src="shipping-city" required minlength="2" />
                                                            <div class="ref-validation-error"></div>
                                                        </label>
                                                        <div class="ref-error-parent"><label><span>Country</span><select class="ref-form-control ref-field-details-country" name="shipping-country" data-state-src="shipping-country" required>
                                    ...
                                    <div>
                                        ...
                                        <div id="myDIV" class="ref-standard-payment-buttons">
                                            <a href="javascript:void()" onclick="disableBackButton(); return konfirmasi(); disabledButton();" id="pay-button" class="ref-button ref-payment-button ref-payment-apple-pay-google-pay button-demo-payment" data-method="stripe">Continue</a>
                                        </div>
...
<script>
    function konfirmasi() {
    $.get("{{ url('konfirmasi') }}", function(data) {
        $("ref-standard-payment-buttons") .html(data);
    });
    }
</script>
